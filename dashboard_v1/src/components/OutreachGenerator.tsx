...
export default function OutreachGenerator({
  ...
  const generateOutreach = async () => {
    ...
    try {
      if (channel === 'call') {
        const res = await fetch(`https://apex-backend-i7b0.onrender.com/api/v2/contacts/${contactId}/generate-call-script`, {
          method: 'POST',
        ...
        const res = await fetch(`https://apex-backend-i7b0.onrender.com/api/v2/contacts/${contactId}/generate-outreach`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const generateSequence = async () => {
    ...
    setSequence([]);
    try {
      const res = await fetch(`https://apex-backend-i7b0.onrender.com/api/v2/contacts/${contactId}/generate-sequence`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
