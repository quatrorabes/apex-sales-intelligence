...
class Apex8PersonaClassifier:
    def __init__(self):
        self.minimum_threshold = 35  # NEW: must hit this to get any persona
        self.rules = {
            'banker': {
                'title_keywords': [
                    ...
                    'relationship manager', 'commercial loan', 'lending specialist', 'credit officer',
                    'underwriter', 'commercial credit analyst', 'chief lending officer', 'clo',
                    'loan portfolio manager', 'risk manager', 'commercial banking', 'senior lender'
                ],
                'company_keywords': [
            ...
            'sba_banker': {
                ...
                'match_keywords': [
                    'sba lending', 'government guaranteed lending',
            ...
            'referral_network_other': {
                'title_keywords': [
                    ...
                    'cdc director', 'sbdc director', 'community development director',
                    'vistage chair', 'executive coach', 'ceo coach',
            ...
            'internal': {
                'title_keywords': [
                    'account manager', 'credit analyst', 'underwriter',
                    'loan processor', 'loan specialist', 'operations manager',
                    'risk manager', 'manager', 'supervisor', 'team lead',
                    'compliance officer', 'loan coordinator', 'internal sales',
                    'team member', 'colleague'
                ],
                'company_keywords': [
                    'bank', 'credit union', 'lending company', 'fintech',
                    'lending platform', 'internal', 'our company'
                ],
                'match_keywords': [
                    'commercial lending', 'loans', 'finance', 'credit analysis',
            ...
            'borrower': {
                'title_keywords': [
                    ...
                    'chief executive', 'cfo', 'chief financial officer',
                    'partner', 'managing partner', 'founder', 'founder & ceo',
                    'founder & president', 'managing member', 'principal',
                    'proprietor', 'practice owner', 'clinic owner',
                    'managing director', 'executive director', 'operations director'
                ],
                'company_keywords': [
                    'llc', 'inc', 'corporation', 'corp', 'company', 'group',
                    'services', 'solutions', 'consulting', 'medical',
                    'dental', 'veterinary', 'law firm', 'legal',
                    'practice', 'clinic', 'wealth management',
                    'financial advisory', 'cpa firm', 'cpa', 'accounting'
                ],
                'match_keywords': [
