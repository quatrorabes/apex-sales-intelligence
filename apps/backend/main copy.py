...
from intelligence.engines.content_generator import ContentGenerator
from intelligence.engines.linkedin_engine import LinkedInEngine
...
async def get_call_assistant_data(contact_id: str):
    ...
    try:
        with get_db() as conn:
            ...
            score = contact.get('apex_score', 0)
            if score >= 75:
                tier = 'HIGH'
            elif score >= 50:
                tier = 'MEDIUM'
            ...
            # Get profile context from enrichment
