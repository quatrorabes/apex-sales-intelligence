#!/bin/bash
# DEPLOY: ContactDetail.tsx - FINAL with Dashboard_v1 Gradient Styling
# Date: Dec 15, 2025 3:30 PM PST
# Target: dashboard_v1/src/pages/ContactDetail.tsx

set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🎨 APEX CONTACTDETAIL.TSX - FINAL STYLING + ENRICHMENT FIX"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "🎨 STYLING IMPROVEMENTS:"
echo "   ✅ Gradient background (blue → indigo → purple)"
echo "   ✅ Elevated cards with shadows + borders"
echo "   ✅ Tab icons and improved hover states"
echo "   ✅ Enhanced badge styling"
echo "   ✅ Gradient PDF download button"
echo "   ✅ Proper empty states"
echo ""
echo "🔧 ENRICHMENT FIXES:"
echo "   ✅ Personality tab → icebreaker + education sections"
echo "   ✅ Fun Facts tab with dedicated mapping"
echo "   ✅ Section fallback logic"
echo "   ✅ Raw Profile formatting"
echo ""

# Backup existing file
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
BACKUP_FILE="dashboard_v1/src/pages/ContactDetail.tsx.backup-${TIMESTAMP}"

if [ -f "dashboard_v1/src/pages/ContactDetail.tsx" ]; then
  echo "📦 Backing up current file..."
  cp dashboard_v1/src/pages/ContactDetail.tsx "$BACKUP_FILE"
  echo "   ✅ Backup: $BACKUP_FILE"
else
  echo "⚠️  Original file not found - new installation"
fi

# Deploy new file
echo ""
echo "📝 Deploying FINAL ContactDetail.tsx..."
cat > dashboard_v1/src/pages/ContactDetail.tsx << 'TYPESCRIPT_EOF'
...
echo "📊 STAGED CHANGES:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
git diff --cached --stat dashboard_v1/src/pages/ContactDetail.tsx
echo ""

# Commit
echo "💾 Committing..."
git commit -m "fix(ContactDetail): apply Dashboard_v1 gradient styling + enrichment fixes

STYLING IMPROVEMENTS:
- Added gradient background: from-blue-50 via-indigo-50 to-purple-50
- Elevated cards with shadow-lg and border styling
- Tab icons (👔 🏢 🧠 ✨📄) for better UX
- Enhanced badge styling with borders and shadows
- Gradient PDF download button (green-600 → emerald-600)
- Improved hover states and transitions
- Min-height content areas (500px)
- Professional empty state messaging

ENRICHMENT FIXES:
- Fixed Personality tab: maps to icebreaker_topics + education + leadership
- Added Fun Facts tab with dedicated section
- Improved section fallback logic (primary → secondary → tertiary)
- Enhanced Raw Profile with section headers
- Removed debug console.log statements

TECHNICAL:
- UUID contact ID support
- API wrapper unwrapping ({success: true, contact: {...}})
- Proper error handling with styled error states

Resolves: White background issue + all enrichment data population
...
echo "📍 NEXT STEPS:"
echo ""
echo "1. Vercel auto-deploy: ~2 minutes"
echo "   https://vercel.com/quatrorabes/apex-sales-intelligence/deployments"
echo ""
echo "2. Test at:"
echo "   https://apex-sales-intelligence.vercel.app/contacts/fdfb18f1-45b0-4273-99e2-a02e0f9f0fbe"
echo ""
echo "3. Verify styling:"
echo "   ✓ Gradient background visible"
echo "   ✓ Cards have elevation/shadows"
echo "   ✓ Tabs have icons"
echo "   ✓ All sections populate with data"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
