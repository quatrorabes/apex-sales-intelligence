#!/bin/bash
# 🚀 DASHBOARD_V1 FULL VISUALIZATION SUITE DEPLOYMENT
# TodaysBoard + Analytics + Pipeline + Smart Lists
# Navy/Indigo Theme Matching ContactsView
# Date: Dec 15, 2025 4:09 PM PST | Apex Sales Intelligence

set -euo pipefail

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📊 DASHBOARD_V1 VISUALIZATION SUITE - FULL LAUNCH"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Backup existing
[ -f "dashboard_v1/src/components/TodaysBoard.tsx" ] && cp "dashboard_v1/src/components/TodaysBoard.tsx" "dashboard_v1/src/components/TodaysBoard.tsx.backup-${TIMESTAMP}"

echo "✅ Deploying TodaysBoard.tsx (Analytics Dashboard)"
...
echo "✅ TodaysBoard.tsx deployed"

# Update App.tsx routing
echo "📝 Updating App.tsx routing..."
cat > "dashboard_v1/src/App.tsx" << 'APP_TSX_EOF'
...
git add dashboard_v1/src/components/TodaysBoard.tsx dashboard_v1/src/App.tsx
git commit -m "feat(Dashboard): launch full visualization suite with TodaysBoard

📊 TODAYSBOARD ANALYTICS:
- Real-time dashboard with /api/todays-board endpoint
- Stats cards: Total, Enriched, High/Med/Low Match, Call Queue
- Top Priority contacts list (APEX scored, enriched)
- Segmented pipeline (High/Medium/Low priority with color coding)
- Auto-refresh every 60s
- Navy/indigo theme matching ContactsView

🎨 DESIGN:
- Gradient background: from-slate-50 via-blue-50 to-indigo-100
- Elevated cards with shadows, borders, hover effects
- Purple/indigo/slate color scheme for segments
- Responsive grid layout (1-3 columns)
- Icons + badges for visual hierarchy

🔧 ROUTING:
- / → /todays-board (default landing)
- /todays-board → Analytics dashboard
...
- Real-time stats
- Visual pipeline segmentation
- Error states with retry
- Loading animations

🧪 TEST: https://apex-sales-intelligence.vercel.app/todays-board"

git push origin main

echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ DASHBOARD_V1 VISUALIZATION SUITE DEPLOYED"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "🚀 Vercel deploying now (~2 min)"
echo ""
echo "📍 LIVE URLS:"
echo "   Dashboard:  https://apex-sales-intelligence.vercel.app/todays-board"
echo "   Contacts:   https://apex-sales-intelligence.vercel.app/contacts"
echo "   Contact:    https://apex-sales-intelligence.vercel.app/contacts/fdfb18f1-45b0-4273-99e2-a02e0f9f0fbe"
echo ""
echo "📊 COMPONENTS SHIPPED:"
echo "   ✅ TodaysBoard (Analytics Dashboard)"
echo "   ✅ Stats Cards (6 metrics)"
echo "   ✅ Top Priority List (enriched contacts)"
echo "   ✅ Segmented Pipeline (High/Med/Low)"
echo "   ✅ App.tsx Routing (default to dashboard)"
echo ""
echo "🎯 NEXT: Test dashboard, verify API endpoint, then add enrichment batch actions?"
echo ""
