#!/bin/bash
# DEPLOY_WORLD_CLASS_CONTACTDETAIL.sh
# Apex Sales Intelligence | World-class ContactDetail design
# Dec 15, 2025 | Matching Deal Intelligence + Contact List aesthetic

set -e

echo "========================================"
echo "APEX World-Class ContactDetail Deploy"
echo "Design: Deal Intelligence + Contact List"
echo "========================================"
...
echo ""
echo "⚠️  This is a complete redesign. Continue? (Enter/Ctrl+C)"
read

cp dashboard_v1/src/pages/ContactDetail.tsx dashboard_v1/src/pages/ContactDetail.tsx.backup-worldclass-$(date +%s)

cat > dashboard_v1/src/pages/ContactDetail.tsx << 'EOFWORLDCLASS'
...
echo "✅ World-class ContactDetail written"
echo ""
echo "📤 Committing to GitHub..."

git add dashboard_v1/src/pages/ContactDetail.tsx
git commit -m "feat(dashboard): World-class ContactDetail with Deal Intelligence design

DESIGN FEATURES:
- Teal gradient header card (matching Deal Intelligence screenshot)
- 7 collapsible sections with colored headers (purple/blue/cyan/green/red)
- STAGE labels (STAGE 1-7) above section titles
- Score badge, tier badge, avatar circle in header
- Dark theme: bg-[#0a0e1a] + cards bg-[#1c2536]
- Lucide icons throughout
- Responsive grid layout for outreach templates

SECTIONS:
1. Target Qualification (purple)
2. Engagement Timing (blue)
3. Conversation Strategy (cyan)
4. AI-Driven Insights (purple)
5. Talking Points (green)
6. Outreach Execution (red)
7. Next Steps (blue)

Dec 15, 2025 | Apex Sales Intelligence | Dashboard_v1 | World-Class Design"

git push origin main

echo ""
echo "✅ DEPLOYED"
echo "🎨 Design: Deal Intelligence + Contact List fusion"
echo "🚀 Vercel rebuilding (~2-3 min)"
