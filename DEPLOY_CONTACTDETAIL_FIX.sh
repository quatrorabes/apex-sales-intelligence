#!/bin/bash
# DEPLOY: ContactDetail.tsx - All Enrichment Fixes
# Date: Dec 15, 2025 3:11 PM PST
# Target: dashboard_v1/src/pages/ContactDetail.tsx

set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🚀 APEX CONTACTDETAIL.TSX - ENRICHMENT DATA FIX DEPLOYMENT"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "📋 FIXES INCLUDED:"
echo "   ✅ Personality tab now maps to icebreaker + education sections"
echo "   ✅ Added Fun Facts tab with dedicated mapping"
echo "   ✅ Removed debug console.log statements"
echo "   ✅ Improved section fallback logic"
echo "   ✅ Enhanced UI with section count badges"
echo "   ✅ Better Raw Profile formatting"
echo ""
...
if [ -f "dashboard_v1/src/pages/ContactDetail.tsx" ]; then
  ...
  echo "⚠️  Warning: Original file not found at dashboard_v1/src/pages/ContactDetail.tsx"
  echo "   This might be a new installation."
fi

# Deploy new file
echo ""
echo "📝 Deploying fixed ContactDetail.tsx..."
...
git commit -m "fix(ContactDetail): map all enrichment sections to tabs

- Fixed Personality tab: now reads icebreaker_topics + education sections
- Added Fun Facts tab with dedicated section mapping
- Removed debug console.log statements
- Improved section fallback logic (primary → secondary → tertiary)
- Added section count badges on tabs (shows KB size)
- Enhanced Raw Profile with section headers
- Improved APEX score badge colors (75+ purple, 50-74 blue, <50 gray)
- Added 'X sections available' indicator badge

Resolves: ContactDetail enrichment data population issue
Test Contact: Dale Holzer (fdfb18f1-45b0-4273-99e2-a02e0f9f0fbe)"
...
echo "   Monitor: https://vercel.com/quatrorabes/apex-sales-intelligence/deployments"
echo ""
echo "2. Test the fixes at:"
echo "   https://apex-sales-intelligence.vercel.app/contacts/fdfb18f1-45b0-4273-99e2-a02e0f9f0fbe"
echo ""
echo "3. Verify all tabs display content:"
echo "   - Professional ✓"
echo "   - Company ✓"
echo "   - Personality ✓ (FIXED)"
echo "   - Fun Facts ✓ (NEW)"
echo "   - Raw Profile ✓"
echo ""
echo "4. Check section count badges appear on each tab"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "   cp $BACKUP_FILE dashboard_v1/src/pages/ContactDetail.tsx"
echo "   git add dashboard_v1/src/pages/ContactDetail.tsx"
echo "   git commit -m 'rollback: restore ContactDetail.tsx'"
echo "   git push origin main"
echo ""
